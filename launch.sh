...
if [ "$1" = "install" ]; then
  ...
  #Adding some color. By @keko11keko
   echo -e "\033[38;5;208m"
   echo -e "     > DEV : keko11keko                                          "
   echo -e "     > DEV : @keko11keko                                           "
   echo -e "     > Bot ID : DEV : @kekohhbot                       "
   echo -e "     > Github : https://github.com/kekobot/kekobot    "
   echo -e "          BY keko11keko                                   \033[0;00m"
   echo -e "\e[36m"
